              ...
              {filteredConversations.map((c) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td
                      className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 flex gap-2"
      ...
      {selectedConversation && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-lg w-full max-w-lg p-6 relative flex flex-col">
            ...
            {/* Chat history */}
            <div className="flex-1 overflow-y-auto space-y-3 mb-4 max-h-80 pr-2">
            ...
            <div className="mt-2">
              ...
              <button
                ...
                className="mt-3 px-4 py-2 bg-indigo-600 text-white rounded-lg flex items-center gap-2 hover:bg-indigo-700 transition-colors"
              >
                <FiSend /> Send Reply
              </button>
            </div>
