  ...
  return (
    <div className="w-full min-h-full p-6 space-y-6">
        ...
        {counts.map(({ label, color, icon: Icon, count }) => {
          ...
          return (
            <motion.div
              key={label}
              whileHover={{ y: -2 }}
              className="rounded-2xl border border-slate-100 bg-white shadow-sm p-4 flex items-center gap-4"
            >
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2.5 rounded-xl border border-slate-200 bg-white text-sm font-semibold text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-300 shadow-sm"
          />
        </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        {/* Header */}
        <div className="hidden sm:grid grid-cols-10 gap-4 px-6 py-3 border-b border-slate-100 bg-slate-50">
