...
const Emergencypage = () => {
  return (
    <div className="flex flex-col h-full overflow-hidden bg-gradient-to-br from-gray-50 via-rose-50 to-indigo-50 w-full">
      <div className="p-6 flex-1 overflow-y-auto">

        {/* Header */}
        <div className="text-center mb-10 space-y-3">
          <div className="flex items-center justify-center gap-4 mb-2">
            <div className="h-1 w-16 bg-gradient-to-r from-transparent to-rose-500 rounded-full" />
            <FiPhone className="text-rose-600 text-4xl animate-pulse" />
            <div className="h-1 w-16 bg-gradient-to-l from-transparent to-rose-500 rounded-full" />
          </div>

          <h1 className="text-6xl font-extrabold bg-gradient-to-r from-rose-600 via-pink-600 to-indigo-600 bg-clip-text text-transparent">
            Emergency Hotlines
          </h1>
